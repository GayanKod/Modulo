    ...
    <>
      ...
      <div className="registration-container">
        ...
        <div className="registration-container-content">
          ...
          <p className="registration-greeting">
            {time < 12 ? "Good morning!" : ""}
            {12 <= time && time < 17 ? "Good Afternoon!" : ""}
            {time >= 17 && time < 24 ? "Good evening!" : ""}
          </p>
          ...
          <div className="registration-form">
            <form onSubmit={handleSubmit} id="reg_form">
                  ...
                  <tr className="formblock-tbl-tr">
                    <td className="formblock-tbl-td">
                      ...
                      <input
                        ...
                        onChange={handleChange("userFName")}
                        value={userFName}
                      />
                    </td>
                    <td className="formblock-tbl-td">
                      ...
                      <input
                        type="text"
                        className="registration-input"
                        onChange={handleChange("userLName")}
                        value={userLName}
                      />
                    </td>
                  </tr>
              ...
              <div className="registration-formblock">
                <table className="formblock-tbl">
                  <tr className="formblock-tbl-tr">
                    ...
                    <td className="formblock-tbl-td">
                      <p className="registration-up">
                        Institute Contact Number
                      </p>
                      <input
                        type="tel"
                        className="registration-input"
                        onChange={handleChange("instituteContactNo")}
              ...
              <div className="registration-PagebtnWrapper">
                <button type="submit" className="registration-Pagebtn">
                  Submit
                </button>
              </div>
            </form>
